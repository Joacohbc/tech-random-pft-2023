...
interface EventoService {
    ...
    @GET("auth/eventos/mios")
    fun getMisEventos(@Header("Authorization") token : String) : Call<List<EventoDTO>>
}

val eventoService: EventoService = retrofit.create(EventoService::class.java)